...
start_hive_server:
	source .venv/bin/activate && spark-submit \
		...
		--conf 'spark.executor.extraJavaOptions=-Djava.security.manager -Djava.security.policy=/Users/hankehly/Projects/JapanHorseRaceAnalytics/spark.policy -Duser.timezone=UTC' \
		--conf 'spark.driver.extraJavaOptions=-Djava.security.manager -Djava.security.policy=/Users/hankehly/Projects/JapanHorseRaceAnalytics/spark.policy -Duser.timezone=UTC' \
