...
class Feature:
    def __init__(self, name: str, pandas_dtype: str, tags: List[str] = []):
        self.name = name
...
class Features:
    ...
    @staticmethod
    def get_feature_names_by_any_tags_and_dtype(any_tags: List[str], dtype: str) -> List[str]:
        """
    ...
    @staticmethod
    def pipe_turf(df):
        return df[df.surface == "芝"]

    @staticmethod
    def pipe_dirt(df):
        return df[df.surface == "ダート"]

    @staticmethod
    def get_pipe_by_tag(tag: str):
        return getattr(Features, f"pipe_{tag}")

    # @staticmethod
    # def pipe_turf_sprint(df):
    #     return df[df.surface == "芝"][df.distance < 1400]

    # @staticmethod
    # def pipe_turf_mile(df):
    #     return df[df.surface == "芝"][df.distance >= 1400][df.distance < 1800]

    # @staticmethod
    # def pipe_turf_middle(df):
    #     return df[df.surface == "芝"][df.distance >= 1800][df.distance < 2400]

    # @staticmethod
    # def pipe_turf_long(df):
    #     return df[df.surface == "芝"][df.distance >= 2400]

    # @staticmethod
    # def pipe_dirt_sprint(df):
    #     return df[df.surface == "ダート"][df.distance < 1400]

    # @staticmethod
    # def pipe_dirt_mile(df):
    #     return df[df.surface == "ダート"][df.distance >= 1400][df.distance < 1800]

    # @staticmethod
    # def pipe_dirt_middle(df):
    #     return df[df.surface == "ダート"][df.distance >= 1800][df.distance < 2400]

    # @staticmethod
    # def pipe_dirt_long(df):
    #     return df[df.surface == "ダート"][df.distance >= 2400]
