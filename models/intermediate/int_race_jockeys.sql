...
with
  ...
  select
    ...
    coalesce(sum(`本賞金`) over (partition by base.`騎手コード` order by `年月日` rows between unbounded preceding and 1 preceding), 0) as `騎手本賞金累計`,

    -- avg_prize_wins_jockey
    coalesce({{
      dbt_utils.safe_divide(
        'sum(`本賞金`) over (partition by base.`騎手コード` order by `年月日` rows between unbounded preceding and 1 preceding)',
        '`騎手1位完走`'
      )
    }}, 0) as `騎手1位完走平均賞金`,
    ...
    lag(race_jockeys_streaks.`騎手連続1着`, 1, 0) over (partition by base.`騎手コード` order by `年月日`) as `騎手連続1着`,
    lag(race_jockeys_streaks.`騎手連続3着内`, 1, 0) over (partition by base.`騎手コード` order by `年月日`) as `騎手連続3着内`
  from
  ...
  select
    ...
    race_jockeys.`騎手1位完走`, -- jockey_wins
    race_jockeys.`騎手トップ3完走`, -- jockey_places
    race_jockeys.`騎手1位完走率`, -- ratio_win_jockey
    race_jockeys.`騎手トップ3完走率`, -- ratio_place_jockey
    race_jockeys.`騎手過去5走勝率`,
    race_jockeys.`騎手過去5走トップ3完走率`,
    race_jockeys.`騎手場所レース数`, -- jockey_venue_runs
    race_jockeys.`騎手場所1位完走`, -- jockey_venue_wins
    race_jockeys.`騎手場所トップ3完走`, -- jockey_venue_places
    race_jockeys.`騎手場所1位完走率`, -- ratio_win_jockey_venue
    race_jockeys.`騎手場所トップ3完走率`, -- ratio_place_jockey_venue
    race_jockeys.`騎手距離レース数`, -- jockey_distance_runs
    race_jockeys.`騎手距離1位完走`, -- jockey_distance_wins
    race_jockeys.`騎手距離トップ3完走`, -- jockey_distance_places
    race_jockeys.`騎手距離1位完走率`, -- ratio_win_jockey_distance
    race_jockeys.`騎手距離トップ3完走率`, -- ratio_place_jockey_distance
    race_jockeys.`騎手本賞金累計`, -- prize_jockey_cumulative
    race_jockeys.`騎手1位完走平均賞金`, -- avg_prize_wins_jockey
    race_jockeys.`騎手レース数平均賞金`, -- avg_prize_runs_jockey
    race_jockeys.`騎手連続1着`,
    race_jockeys.`騎手連続3着内`,

    competitors.`競争相手最大騎手レース数`,
    competitors.`競争相手最小騎手レース数`,
    competitors.`競争相手平均騎手レース数`,
    competitors.`競争相手騎手レース数標準偏差`,
    competitors.`競争相手最大騎手1位完走`,
    competitors.`競争相手最小騎手1位完走`,
    competitors.`競争相手平均騎手1位完走`,
    competitors.`競争相手騎手1位完走標準偏差`,
    competitors.`競争相手最大騎手トップ3完走`,
    competitors.`競争相手最小騎手トップ3完走`,
    competitors.`競争相手平均騎手トップ3完走`,
    competitors.`競争相手騎手トップ3完走標準偏差`,
    competitors.`競争相手最大騎手1位完走率`,
    competitors.`競争相手最小騎手1位完走率`,
    competitors.`競争相手平均騎手1位完走率`,
    competitors.`競争相手騎手1位完走率標準偏差`,
    competitors.`競争相手最大騎手トップ3完走率`,
    competitors.`競争相手最小騎手トップ3完走率`,
    competitors.`競争相手平均騎手トップ3完走率`,
    competitors.`競争相手騎手トップ3完走率標準偏差`,
    competitors.`競争相手最大騎手過去5走勝率`,
    competitors.`競争相手最小騎手過去5走勝率`,
    competitors.`競争相手平均騎手過去5走勝率`,
    competitors.`競争相手騎手過去5走勝率標準偏差`,
    competitors.`競争相手最大騎手過去5走トップ3完走率`,
    competitors.`競争相手最小騎手過去5走トップ3完走率`,
    competitors.`競争相手平均騎手過去5走トップ3完走率`,
    competitors.`競争相手騎手過去5走トップ3完走率標準偏差`,
    competitors.`競争相手最大騎手場所レース数`,
    competitors.`競争相手最小騎手場所レース数`,
    competitors.`競争相手平均騎手場所レース数`,
    competitors.`競争相手騎手場所レース数標準偏差`,
    competitors.`競争相手最大騎手場所1位完走`,
    competitors.`競争相手最小騎手場所1位完走`,
    competitors.`競争相手平均騎手場所1位完走`,
    competitors.`競争相手騎手場所1位完走標準偏差`,
    competitors.`競争相手最大騎手場所トップ3完走`,
    competitors.`競争相手最小騎手場所トップ3完走`,
    competitors.`競争相手平均騎手場所トップ3完走`,
    competitors.`競争相手騎手場所トップ3完走標準偏差`,
    competitors.`競争相手最大騎手場所1位完走率`,
    competitors.`競争相手最小騎手場所1位完走率`,
    competitors.`競争相手平均騎手場所1位完走率`,
    competitors.`競争相手騎手場所1位完走率標準偏差`,
    competitors.`競争相手最大騎手場所トップ3完走率`,
    competitors.`競争相手最小騎手場所トップ3完走率`,
    competitors.`競争相手平均騎手場所トップ3完走率`,
    competitors.`競争相手騎手場所トップ3完走率標準偏差`,
    competitors.`競争相手最大騎手距離レース数`,
    competitors.`競争相手最小騎手距離レース数`,
    competitors.`競争相手平均騎手距離レース数`,
    competitors.`競争相手騎手距離レース数標準偏差`,
    competitors.`競争相手最大騎手距離1位完走`,
    competitors.`競争相手最小騎手距離1位完走`,
    competitors.`競争相手平均騎手距離1位完走`,
    competitors.`競争相手騎手距離1位完走標準偏差`,
    competitors.`競争相手最大騎手距離トップ3完走`,
    competitors.`競争相手最小騎手距離トップ3完走`,
    competitors.`競争相手平均騎手距離トップ3完走`,
    competitors.`競争相手騎手距離トップ3完走標準偏差`,
    competitors.`競争相手最大騎手距離1位完走率`,
    competitors.`競争相手最小騎手距離1位完走率`,
    competitors.`競争相手平均騎手距離1位完走率`,
    competitors.`競争相手騎手距離1位完走率標準偏差`,
    competitors.`競争相手最大騎手距離トップ3完走率`,
    competitors.`競争相手最小騎手距離トップ3完走率`,
    competitors.`競争相手平均騎手距離トップ3完走率`,
    competitors.`競争相手騎手距離トップ3完走率標準偏差`,
    competitors.`競争相手最大騎手本賞金累計`,
    competitors.`競争相手最小騎手本賞金累計`,
    competitors.`競争相手平均騎手本賞金累計`,
    competitors.`競争相手騎手本賞金累計標準偏差`,
    competitors.`競争相手最大騎手1位完走平均賞金`,
    competitors.`競争相手最小騎手1位完走平均賞金`,
    competitors.`競争相手平均騎手1位完走平均賞金`,
    competitors.`競争相手騎手1位完走平均賞金標準偏差`,
    competitors.`競争相手最大騎手レース数平均賞金`,
    competitors.`競争相手最小騎手レース数平均賞金`,
    competitors.`競争相手平均騎手レース数平均賞金`,
    competitors.`競争相手騎手レース数平均賞金標準偏差`,
    competitors.`競争相手最高騎手連続1着`,
    competitors.`競争相手最低騎手連続1着`,
    competitors.`競争相手平均騎手連続1着`,
    competitors.`競争相手騎手連続1着標準偏差`,
    competitors.`競争相手最高騎手連続3着内`,
    competitors.`競争相手最低騎手連続3着内`,
    competitors.`競争相手平均騎手連続3着内`,
    competitors.`競争相手騎手連続3着内標準偏差`,

    -- relative to competitors
    race_jockeys.`騎手レース数` - competitors.`競争相手平均騎手レース数` as `競争相手平均騎手レース数差`,
    race_jockeys.`騎手1位完走` - competitors.`競争相手平均騎手1位完走` as `競争相手平均騎手1位完走差`,
    race_jockeys.`騎手トップ3完走` - competitors.`競争相手平均騎手トップ3完走` as `競争相手平均騎手トップ3完走差`,
    race_jockeys.`騎手1位完走率` - competitors.`競争相手平均騎手1位完走率` as `競争相手平均騎手1位完走率差`,
    race_jockeys.`騎手トップ3完走率` - competitors.`競争相手平均騎手トップ3完走率` as `競争相手平均騎手トップ3完走率差`,
    race_jockeys.`騎手過去5走勝率` - competitors.`競争相手平均騎手過去5走勝率` as `競争相手平均騎手過去5走勝率差`,
    race_jockeys.`騎手過去5走トップ3完走率` - competitors.`競争相手平均騎手過去5走トップ3完走率` as `競争相手平均騎手過去5走トップ3完走率差`,
    race_jockeys.`騎手場所レース数` - competitors.`競争相手平均騎手場所レース数` as `競争相手平均騎手場所レース数差`,
    race_jockeys.`騎手場所1位完走` - competitors.`競争相手平均騎手場所1位完走` as `競争相手平均騎手場所1位完走差`,
    race_jockeys.`騎手場所トップ3完走` - competitors.`競争相手平均騎手場所トップ3完走` as `競争相手平均騎手場所トップ3完走差`,
    race_jockeys.`騎手場所1位完走率` - competitors.`競争相手平均騎手場所1位完走率` as `競争相手平均騎手場所1位完走率差`,
    race_jockeys.`騎手場所トップ3完走率` - competitors.`競争相手平均騎手場所トップ3完走率` as `競争相手平均騎手場所トップ3完走率差`,
    race_jockeys.`騎手距離レース数` - competitors.`競争相手平均騎手距離レース数` as `競争相手平均騎手距離レース数差`,
    race_jockeys.`騎手距離1位完走` - competitors.`競争相手平均騎手距離1位完走` as `競争相手平均騎手距離1位完走差`,
    race_jockeys.`騎手距離トップ3完走` - competitors.`競争相手平均騎手距離トップ3完走` as `競争相手平均騎手距離トップ3完走差`,
    race_jockeys.`騎手距離1位完走率` - competitors.`競争相手平均騎手距離1位完走率` as `競争相手平均騎手距離1位完走率差`,
    race_jockeys.`騎手距離トップ3完走率` - competitors.`競争相手平均騎手距離トップ3完走率` as `競争相手平均騎手距離トップ3完走率差`,
    race_jockeys.`騎手本賞金累計` - competitors.`競争相手平均騎手本賞金累計` as `競争相手平均騎手本賞金累計差`,
    race_jockeys.`騎手1位完走平均賞金` - competitors.`競争相手平均騎手1位完走平均賞金` as `競争相手平均騎手1位完走平均賞金差`,
