...
with
  ...
  final as (
  select
    race_jockeys_base.`unique_key`,
    race_jockeys_base.`レースキー`,
    race_jockeys_base.`馬番`,
  ...
  inner join
    race_jockeys
  on
    race_jockeys_base.`レースキー` = race_jockeys.`レースキー`
    and race_jockeys_base.`馬番` = race_jockeys.`馬番`
  )
