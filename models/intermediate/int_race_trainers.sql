with
  ...
  select
    ...
    race_trainers.`調教師1位完走` as `num_調教師1位完走`,
    race_trainers.`調教師トップ3完走` as `num_調教師トップ3完走`,
    race_trainers.`調教師1位完走率` as `num_調教師1位完走率`,
    race_trainers.`調教師トップ3完走率` as `num_調教師トップ3完走率`,
    race_trainers.`調教師場所レース数` as `num_調教師場所レース数`,
    race_trainers.`調教師場所1位完走` as `num_調教師場所1位完走`,
    race_trainers.`調教師場所トップ3完走` as `num_調教師場所トップ3完走`,
    race_trainers.`調教師場所1位完走率` as `num_調教師場所1位完走率`,
    race_trainers.`調教師場所トップ3完走率` as `num_調教師場所トップ3完走率`,
    race_trainers.`調教師本賞金累計` as `num_調教師本賞金累計`,
    race_trainers.`調教師1位完走平均賞金` as `num_調教師1位完走平均賞金`,
    race_trainers.`調教師レース数平均賞金` as `num_調教師レース数平均賞金`,

    -- Competitor features
    competitors.`競争相手最高調教師レース数` as `num_競争相手最高調教師レース数`,
    competitors.`競争相手最低調教師レース数` as `num_競争相手最低調教師レース数`,
    competitors.`競争相手平均調教師レース数` as `num_競争相手平均調教師レース数`,
    competitors.`競争相手調教師レース数標準偏差` as `num_競争相手調教師レース数標準偏差`,
    competitors.`競争相手最高調教師1位完走` as `num_競争相手最高調教師1位完走`,
    competitors.`競争相手最低調教師1位完走` as `num_競争相手最低調教師1位完走`,
    competitors.`競争相手平均調教師1位完走` as `num_競争相手平均調教師1位完走`,
    competitors.`競争相手調教師1位完走標準偏差` as `num_競争相手調教師1位完走標準偏差`,
    competitors.`競争相手最高調教師トップ3完走` as `num_競争相手最高調教師トップ3完走`,
    competitors.`競争相手最低調教師トップ3完走` as `num_競争相手最低調教師トップ3完走`,
    competitors.`競争相手平均調教師トップ3完走` as `num_競争相手平均調教師トップ3完走`,
    competitors.`競争相手調教師トップ3完走標準偏差` as `num_競争相手調教師トップ3完走標準偏差`,
    competitors.`競争相手最高調教師1位完走率` as `num_競争相手最高調教師1位完走率`,
    competitors.`競争相手最低調教師1位完走率` as `num_競争相手最低調教師1位完走率`,
    competitors.`競争相手平均調教師1位完走率` as `num_競争相手平均調教師1位完走率`,
    competitors.`競争相手調教師1位完走率標準偏差` as `num_競争相手調教師1位完走率標準偏差`,
    competitors.`競争相手最高調教師トップ3完走率` as `num_競争相手最高調教師トップ3完走率`,
    competitors.`競争相手最低調教師トップ3完走率` as `num_競争相手最低調教師トップ3完走率`,
    competitors.`競争相手平均調教師トップ3完走率` as `num_競争相手平均調教師トップ3完走率`,
    competitors.`競争相手調教師トップ3完走率標準偏差` as `num_競争相手調教師トップ3完走率標準偏差`,
    competitors.`競争相手最高調教師場所レース数` as `num_競争相手最高調教師場所レース数`,
    competitors.`競争相手最低調教師場所レース数` as `num_競争相手最低調教師場所レース数`,
    competitors.`競争相手平均調教師場所レース数` as `num_競争相手平均調教師場所レース数`,
    competitors.`競争相手調教師場所レース数標準偏差` as `num_競争相手調教師場所レース数標準偏差`,
    competitors.`競争相手最高調教師場所1位完走` as `num_競争相手最高調教師場所1位完走`,
    competitors.`競争相手最低調教師場所1位完走` as `num_競争相手最低調教師場所1位完走`,
    competitors.`競争相手平均調教師場所1位完走` as `num_競争相手平均調教師場所1位完走`,
    competitors.`競争相手調教師場所1位完走標準偏差` as `num_競争相手調教師場所1位完走標準偏差`,
    competitors.`競争相手最高調教師場所トップ3完走` as `num_競争相手最高調教師場所トップ3完走`,
    competitors.`競争相手最低調教師場所トップ3完走` as `num_競争相手最低調教師場所トップ3完走`,
    competitors.`競争相手平均調教師場所トップ3完走` as `num_競争相手平均調教師場所トップ3完走`,
    competitors.`競争相手調教師場所トップ3完走標準偏差` as `num_競争相手調教師場所トップ3完走標準偏差`,
    competitors.`競争相手最高調教師場所1位完走率` as `num_競争相手最高調教師場所1位完走率`,
    competitors.`競争相手最低調教師場所1位完走率` as `num_競争相手最低調教師場所1位完走率`,
    competitors.`競争相手平均調教師場所1位完走率` as `num_競争相手平均調教師場所1位完走率`,
    competitors.`競争相手調教師場所1位完走率標準偏差` as `num_競争相手調教師場所1位完走率標準偏差`,
    competitors.`競争相手最高調教師場所トップ3完走率` as `num_競争相手最高調教師場所トップ3完走率`,
    competitors.`競争相手最低調教師場所トップ3完走率` as `num_競争相手最低調教師場所トップ3完走率`,
    competitors.`競争相手平均調教師場所トップ3完走率` as `num_競争相手平均調教師場所トップ3完走率`,
    competitors.`競争相手調教師場所トップ3完走率標準偏差` as `num_競争相手調教師場所トップ3完走率標準偏差`,
    competitors.`競争相手最高調教師本賞金累計` as `num_競争相手最高調教師本賞金累計`,
    competitors.`競争相手最低調教師本賞金累計` as `num_競争相手最低調教師本賞金累計`,
    competitors.`競争相手平均調教師本賞金累計` as `num_競争相手平均調教師本賞金累計`,
    competitors.`競争相手調教師本賞金累計標準偏差` as `num_競争相手調教師本賞金累計標準偏差`,
    competitors.`競争相手最高調教師1位完走平均賞金` as `num_競争相手最高調教師1位完走平均賞金`,
    competitors.`競争相手最低調教師1位完走平均賞金` as `num_競争相手最低調教師1位完走平均賞金`,
    competitors.`競争相手平均調教師1位完走平均賞金` as `num_競争相手平均調教師1位完走平均賞金`,
    competitors.`競争相手調教師1位完走平均賞金標準偏差` as `num_競争相手調教師1位完走平均賞金標準偏差`,
    competitors.`競争相手最高調教師レース数平均賞金` as `num_競争相手最高調教師レース数平均賞金`,
    competitors.`競争相手最低調教師レース数平均賞金` as `num_競争相手最低調教師レース数平均賞金`,
    competitors.`競争相手平均調教師レース数平均賞金` as `num_競争相手平均調教師レース数平均賞金`,
    competitors.`競争相手調教師レース数平均賞金標準偏差` as `num_競争相手調教師レース数平均賞金標準偏差`,

    -- Relative features
    race_trainers.`調教師レース数` - competitors.`競争相手平均調教師レース数` as `num_競争相手平均調教師レース数差`,
    race_trainers.`調教師1位完走` - competitors.`競争相手平均調教師1位完走` as `num_競争相手平均調教師1位完走差`,
    race_trainers.`調教師トップ3完走` - competitors.`競争相手平均調教師トップ3完走` as `num_競争相手平均調教師トップ3完走差`,
    race_trainers.`調教師1位完走率` - competitors.`競争相手平均調教師1位完走率` as `num_競争相手平均調教師1位完走率差`,
    race_trainers.`調教師トップ3完走率` - competitors.`競争相手平均調教師トップ3完走率` as `num_競争相手平均調教師トップ3完走率差`,
    race_trainers.`調教師場所レース数` - competitors.`競争相手平均調教師場所レース数` as `num_競争相手平均調教師場所レース数差`,
    race_trainers.`調教師場所1位完走` - competitors.`競争相手平均調教師場所1位完走` as `num_競争相手平均調教師場所1位完走差`,
    race_trainers.`調教師場所トップ3完走` - competitors.`競争相手平均調教師場所トップ3完走` as `num_競争相手平均調教師場所トップ3完走差`,
    race_trainers.`調教師場所1位完走率` - competitors.`競争相手平均調教師場所1位完走率` as `num_競争相手平均調教師場所1位完走率差`,
    race_trainers.`調教師場所トップ3完走率` - competitors.`競争相手平均調教師場所トップ3完走率` as `num_競争相手平均調教師場所トップ3完走率差`,
    race_trainers.`調教師本賞金累計` - competitors.`競争相手平均調教師本賞金累計` as `num_競争相手平均調教師本賞金累計差`,
    race_trainers.`調教師1位完走平均賞金` - competitors.`競争相手平均調教師1位完走平均賞金` as `num_競争相手平均調教師1位完走平均賞金差`,
    race_trainers.`調教師レース数平均賞金` - competitors.`競争相手平均調教師レース数平均賞金` as `num_競争相手平均調教師レース数平均賞金差`
  from
    race_trainers
  inner join
    competitors
