...
with
  ...
  select
    ...
    kab."芝馬場状態内",  -- category ordinal
    kab."芝馬場状態中",  -- category ordinal
    kab."芝馬場状態外",  -- category ordinal
    kab."直線馬場差最内",
    kab."直線馬場差内",
    kab."直線馬場差中",
    kab."直線馬場差外",
    kab."直線馬場差大外",
    kab."ダ馬場状態内",  -- category ordinal
    kab."ダ馬場状態中",  -- category ordinal
    kab."ダ馬場状態外",  -- category ordinal
    kab."芝種類",
    kab."草丈",
    kab."転圧", -- category
    kab."凍結防止剤",  -- category
