with
  ...
  select
    ...
    cast(nullif(`蒸気圧`, '') as float) as `蒸気圧`,
    nullif(`蒸気圧_品質情報`, '') as `蒸気圧_品質情報`,
    nullif(`蒸気圧_均質番号`, '') as `蒸気圧_均質番号`,
    cast(nullif(`露点温度`, '') as float) as `露点温度`,
