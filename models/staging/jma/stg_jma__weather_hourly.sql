with
  ...
  select
    ...
    cast(nullif(`蒸気圧`, '') as double) as `蒸気圧`,
    nullif(`蒸気圧_品質情報`, '') as `蒸気圧_品質情報`,
    nullif(`蒸気圧_均質番号`, '') as `蒸気圧_均質番号`,
    cast(nullif(`露点温度`, '') as double) as `露点温度`,
    ...
    cast(nullif(`視程`, '') as double) as `視程`,
