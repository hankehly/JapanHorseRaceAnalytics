with
  ...
  select
    ...
    cast(nullif(`ＪＲＤＢデータ_不利`, '') as integer) as `ＪＲＤＢデータ_不利`,
    cast(nullif(`ＪＲＤＢデータ_前不利`, '') as integer) as `ＪＲＤＢデータ_前不利`,
    cast(nullif(`ＪＲＤＢデータ_中不利`, '') as integer) as `ＪＲＤＢデータ_中不利`,
    cast(nullif(`ＪＲＤＢデータ_後不利`, '') as integer) as `ＪＲＤＢデータ_後不利`,
