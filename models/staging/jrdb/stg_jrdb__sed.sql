with
  ...
  select
    ...
    cast(nullif(`馬成績_確定単勝オッズ`, '') as float) as `馬成績_確定単勝オッズ`,
    nullif(`馬成績_確定単勝人気順位`, '') as `馬成績_確定単勝人気順位`,
    cast(nullif(`ＪＲＤＢデータ_ＩＤＭ`, '') as float) as `ＪＲＤＢデータ_ＩＤＭ`,
    ...
    cast(nullif(`確定複勝オッズ下`, '') as float) as `確定複勝オッズ下`,
    ...
    cast(nullif(`本賞金`, '') as float) as `本賞金`,
